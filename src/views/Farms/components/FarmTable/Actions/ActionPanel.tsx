...
const ActionPanel: React.FC<ActionPanelProps> = ({ details, apr, multiplier, liquidity }) => {
  const farm = details
  ...
  return (
    <Container>
      <InfoContainer>
        <StakeContainer>
          Stake:
          <StyledLinkExternal href={`https://exchange.pancakeswap.finance/#/add/${liquidityUrlPathParts}`} ml="8px">
            {lpLabel}
          </StyledLinkExternal>
        </StakeContainer>
